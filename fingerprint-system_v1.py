        ...
        def process_queue():
            while True:
                try:
                    ...
                    self.canvas.after(0, lambda e=e: self.canvas.itemconfig(
...
def capture_fingerprint_with_usb():
    try:
        ...
        subprocess.Popen(['D:/Bin/Debug/x64/UareUSampleCSharp_CaptureOnly.exe'])
...
# Original UI elements (from your provided code)
canvas.create_rectangle(0.0, 3.0, 1000.0, 74.0, fill="#5370EF", outline="")
display = canvas.create_rectangle(63.0, 99.0, 297.0, 333.0, fill="#FAFAFA", outline="")
submit_button = canvas.create_rectangle(419.0, 165.0, 581.0, 213.0, fill="#FAFAFA", outline="")
input_button_img = canvas.create_rectangle(63.0, 449.0, 297.0, 499.0,fill="#D9D9D9",outline="")
